...
>
> 定位更新（2026-08）：系统已升级为「运营支撑助手」——通话/短信只用于通知
> 运维工作人员（客户经理、网络维护责任人、审核人员），不是通知客户本人；
> 「回访计划」概念已由「扫描通知配置」（`scan_schedules`，每日/每周定时扫描
> 生成通知任务）取代，详见 TODO.md「运营支撑助手」章节与 README.md。
